  ...
  Widget build(BuildContext context) {
    ...
    return MaterialApp(
      ...
      theme: ThemeData(
        ...
        colorScheme: ColorScheme.fromSeed(seedColor: const Color.fromARGB(255, 228, 27, 255)), // Gera um esquema de cores baseado na cor deepPurple.
        useMaterial3: true, // Ativa o estilo Material Design 3.
      ),
      home: const MyHomePage(title: 'Primeiro progama da bibi milani'), // Define a página inicial do aplicativo.
    );
  }
}
        ...
        child: Column(
          ...
          children: <Widget>[
            const Text(
              ...
              'progama da bibiz , clique no + para mudar a pontuação:',
            ),
            Text(
